        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="section-title">
                    <h3 class="title">Danh sách sản phẩm yêu thích</h3>
                </div>
            </div>
            <!-- /section title -->
            <c:if test="${sessionScope.username != null}">
                                ...
                                <c:forEach var="p" items="${products}">
                                    ...
                                    <div class="product" >
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h4 class="product-price">$${p.sellPrice}<del class="product-old-price">$${p.price}</del></h4>
                                        ...
                                        <div class="add-to-cart">
                                            <button class="add-to-cart-btn"><a href="/shop_war/AddCart?id=${p.id}"><i class="fa fa-shopping-cart"></i> add to cart</a></button>
                                        </div>
                                    </div>
                                    <!-- /product -->
                                </c:forEach>
