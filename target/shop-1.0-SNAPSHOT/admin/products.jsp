                ...
                <div class="tm-product-table-container">
                    <table class="table table-hover tm-table-small tm-product-table">
                        ...
                        <tr>
                            ...
                            <td>28 March 2022</td>
                            <td>
                                <a href="DeleteProductController?sid=${p.id}" class="tm-product-delete-link">
                                    <i class="far fa-trash-alt tm-product-delete-icon"></i>
                                </a>
                                <a href="edit-product?sid=${p.id}" class="tm-product-delete-link">
            ...
            <div class="tm-bg-primary-dark tm-block tm-block-product-categories">
                ...
                <div class="tm-product-table-container">
                    <table class="table tm-table-small tm-product-table">
                        ...
                        <tr>
                            <td class="tm-product-name">Man Shoe</td>
                        ...
                        <tr>
                            <td class="tm-product-name">Shina Shoe</td>
                            <td class="text-center">
                                <a href="#" class="tm-product-delete-link">
                                    <i class="far fa-trash-alt tm-product-delete-icon"></i>
                                </a>
                        ...
                        <tr>
                        <tr>
                            <td class="tm-product-name">Dana Shoe</td>
                            <td class="text-center">
                                <a href="#" class="tm-product-delete-link">
                                    <i class="far fa-trash-alt tm-product-delete-icon"></i>
                                </a>
                        ...
                        <tr>
                            <td class="tm-product-name">Uowy Shoe</td>
                            <td class="text-center">
                                <a href="#" class="tm-product-delete-link">
                                    <i class="far fa-trash-alt tm-product-delete-icon"></i>
                                </a>
...
<%--        if(option == true ){--%>
<%--            window.location.href='DeleteProductController?sid='+id;--%>
<%--        }--%>
<%--    }--%>
<%--</script>--%>
</body>
