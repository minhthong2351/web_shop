...
<div class="container">
    <div class="content">
        ...
        <form action="login" method="post">
            <input type="text" name="uname" class="inputTxt" placeholder="Tài khoản">
            <input type="password" name="pass" class="inputTxt" style="margin-bottom: 45px;" placeholder="Mật khẩu">
