                ...
                <div class="row d-flex align-items-center justify-content-center h-100" style="text-align: center;">
                    <div class="">
                        <div class="col-md-6 col-lg-5 col-xl-6 ">
                            <img src="./img/topic.jpg" class="img-fluid topic" alt="Phone image">
                        </div>
                        <form class="col-md-6 col-lg-5 col-xl-5 offset-xl-1 formlogin" action="/shop_war/doForgot" method="post">
                            ...
                            <div class="form-outline mb-4 ">
                                ...
                                <input type="text" placeholder="Username" name="username" class="form-control form-control-lg" />
                            </div>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="email" placeholder="@gmail.com" name="email" class="form-control form-control-lg" />
                            </div>
                            ...
                            <div class="d-flex justify-content-around align-items-center mb-4">
                                ...
                                <a class = "fpg" href="register.jsp">Register here!</a>
                            </div>
