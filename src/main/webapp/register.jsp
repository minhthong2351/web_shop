            ...
            <div class="container py-5 h-100">
                <div class="row d-flex align-items-center justify-content-center h-100" style="text-align: center; ">
                    <div class="col-md-6 col-lg-5 col-xl-6">
                        <img src="./img/topic.jpg" class="img-fluid topic" style="width: 100%" alt="Phone image">
                    </div>
                    <div >
                        <form class="col-md-6 col-lg-5 col-xl-5 offset-xl-1 formregister " action="/shop_war/doRegister" method="post">
                            ...
                            <div class="form-outline mb-4">
                                <label class="form-label"><i class="fa fa-lock"></i> Re-Enter Password</label>
                                <input type="password" placeholder="Password" name="repassword" required class="form-control form-control-lg" />
                            </div>
                            <div class="form-outline mb-4">
                                <label class="form-label"><i class="fa fa-user"></i> Name</label>
                                <input type="text" placeholder="Name" name="name" required class="form-control form-control-lg" />
                            </div>

                            <div class="form-outline mb-4">
                                <label class="form-label"><i class="fa fa-phone"></i> Phone Number</label>
                                <input type="text" placeholder="PhoneNumber" name="phone" required class="form-control form-control-lg" />
                            </div>

                            <div class="form-outline mb-4">
                                <label class="form-label"><i class="fa fa-envelope"></i> Email</label>
                                <input type="email" placeholder="@gmail.com" name="email" required class="form-control form-control-lg" />
                            </div>

                            <div class="form-outline mb-4">
                                <label class="form-label"><i class="fa fa-location-arrow"></i> Address</label>
                                <input type="text" placeholder="Address" name="address" required class="form-control form-control-lg" />
                            </div>
                            ...
                            <div class="d-flex justify-content-around align-items-center mb-4">
                                ...
                                <div class="form-check">
                                    ...
                                    <a class = "fpg" href="forgotpassword.jsp">Forgot password?</a>
                                </div >
                                <a class = "fpg" href="login.jsp">Login here!</a>
                            </div>
                            ...
                            <div class="divider d-flex align-items-center my-4">
                                <p class="text-center fw-bold mx-3 mb-0 text-muted" style="margin-top: 10px;">OR</p>
                            </div>

                            <a class="btn btn-primary btn-lg btn-block" style="background-color: #3b5998" href="#!" role="button">
                                <i class="fa fa-facebook me-2"></i> login with Facebook
                            </a>
                            <a class="btn btn-primary btn-lg btn-block" style="background-color: #f11414" href="#!" role="button">
                                <i class="fa fa-google me-2"></i> login with Google</a>
