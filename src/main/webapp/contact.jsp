    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="billing-details">
                ...
                <div class="col-md-6 from-info">
                    <p href="#"><i class="fa fa-phone"></i> +021-95-51-84</p>
                    <p href="#"><i class="fa fa-envelope-o"></i> email@email.com</p>
                    <p href="#"><i class="fa fa-map-marker"></i> 1734 Stonecoal Road</p>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-6 form-name">
                        <input class="contact-input" type="text" name="first-name" placeholder="First Name">
                    </div>
                    <div class="form-group col-md-6 form-name">
                        <input class="contact-input" type="text" name="last-name" placeholder="Last Name">
                    </div>
                    <div class="form-group">
                        <input class="contact-input" type="email" name="email" placeholder="Email">
                    </div>
                    <div class="form-group">
                        <input class="contact-input" type="text" name="address" placeholder="Message">
                    </div>
