<%@ page import="com.shop.beans.Cart" %>
...
%>
<jsp:useBean id="cart" scope="request" type="com.shop.beans.Cart"/>
...
<html lang="en">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="css/gio_hang.css"/>
		...
		<div class="container">
		 <table id="cart" class="table table-hover table-condensed">
		  ...
		  <tr>
		   ...
		   <td data-th="Quantity"><input class="form-control text-center " id="changeQuantity" oldQuantity="${product.quantitySold}" pid="${product.id}" value="${product.quantitySold}" type="number">
		   </td>
		   <td data-th="Subtotal" class="text-center">${product.getTotal()}</td>
		   <td class="actions" data-th="">
			<button class="btn btn-info btn-sm"><a class=""><i class="fa fa-edit"></i></a>
			</button>
			<button class="btn btn-danger btn-sm"><a class="cart-remove" pid="${product.id}"> <i class="fa fa-trash-o"></i></a>
			 ...
			 <tfoot>
		   <tr>
			<td><a href="/shop_war/store" class="btn btn-warning"><i class="fa fa-angle-left"></i> Tiếp tục mua hàng</a>

			</td>
			<td colspan="2" class="hidden-xs"> </td>

			<td class="hidden-xs text-center" ><strong>Tổng tiền $${cart.getTotal()}</strong>
			</td>
			<td>
					<a href="/shop_war/thanh_toan.jsp" class="btn btn-success btn-block">Thanh toán <i class="fa fa-angle-right"></i></a>
		...
		<script>
			$(document).ready(function (){
				...
				$(".form-control").blur(function (){
					let id=$(this).attr("pid");
					let update=$(this);
					let oldQuantity = $(this).attr("oldQuantity");
					let quantity = $(this).val();
					if(oldQuantity!=quantity)
						$.ajax({
							url: "/shop_war/UpdateCart",
							method: "POST",
							data: {
								id: id,
								quantity:quantity
